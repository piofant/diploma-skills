...
Если есть доступ к внешнему ИИ-детектору с API (в кейсе автора — нейродетектор Яндекса) — превратить переписывание из «на ощущениях» в **измеримую оптимизацию**. Это применение общего скилла `autoresearch` к метрике «% ИИ».
